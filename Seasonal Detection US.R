...
Q1_iso <- subset(Q1_iso, Q1_iso$Q1_2019_Total + Q1_iso$Q1_2020_Total >= 250)
...
Q2_iso <- subset(Q2_iso, Q2_iso$Q2_2019_Total + Q2_iso$Q2_2020_Total >= 250)
...
Q3_iso <- subset(Q3_iso, Q3_iso$Q3_2019_Total + Q3_iso$Q3_2020_Total >= 250)
...
Q4_iso <- subset(Q4_iso, Q4_iso$Q4_2019_Total + Q4_iso$Q4_2020_Total >= 250)
...
Q_iso <- rbind.data.frame(Q_iso, c("1465489665","9781465489661","Baby's First St Patrick's Day","Q2")  )
Q_iso <- rbind.data.frame(Q_iso, c("0756689872","9780756689872","Baby Touch and Feel: Bunny","Q2")  )
Q_iso <- rbind.data.frame(Q_iso, c("0756634687","9780756634681","Baby Touch and Feel: Animals","Q2")  )


saveRDS(Q_iso, "Q_iso_US.csv")
